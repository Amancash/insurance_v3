"""
app.py  —  InsureIQ v3 Backend
Features: Predict, What-If Optimizer, SHAP XAI, Report Parser, Wearable Sync, Social Benchmarking
...
app = FastAPI(title="InsureIQ API", version="3.0.0")
